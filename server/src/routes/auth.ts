...
import { createUser, loginUser, getUserInfo, createTutor, loginTutor, getTutorInfo } from "../controllers/authController";
...
export default (router: Router) => {
    ...
    router.route("/api/auth/tutor/getuser").get(fetchuser, (req: any, res: Response)=>getTutorInfo(req, res));
} 