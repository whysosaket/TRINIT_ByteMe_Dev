...
import TutorCard, { TutorCardSkeleton } from "../components/studentDashboard/StudentScheduleCard";
...
const StudentScheduledClasses = () => {
    ...
    const {getStudentSchedule} = useContext(ClassroomContext);
    ...
    useEffect(() => {
        const fetchClasses = async () => {
            const classes = await getStudentSchedule();
            setClasses(classes);
            console.log(classes);
            }
        fetchClasses();
